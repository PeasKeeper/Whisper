...
---
### Build
To build this chat use `./build.sh` (builds both the server and the client by default).  
To build only the server or the client use `./build.sh server` or `./build.sh client`.  
